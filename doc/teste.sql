...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Dez-2018 às 23:28
...
--
-- Estrutura da tabela `banco_de_talentos`
--
...
CREATE TABLE `cursos` (
  ...
  `data_final_curso` datetime NOT NULL,
...
--
-- Estrutura da tabela `cursos_cidade`
--

CREATE TABLE `cursos_cidade` (
  `id` int(11) NOT NULL,
...
--
-- Estrutura da tabela `gerencia_staff_sede`
--

CREATE TABLE `gerencia_staff_sede` (
  `id` int(11) NOT NULL,
  `status` varchar(1) DEFAULT NULL,
  `FK_Staff_id` int(11) DEFAULT NULL,
  `FK_Sede_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `gerencia_staff_sede`
--

INSERT INTO `gerencia_staff_sede` (`id`, `status`, `FK_Staff_id`, `FK_Sede_id`) VALUES
(52, '1', 1, 12),
(53, '1', 1, 9),
(54, '1', 1, 10),
(55, '1', 1, 11);
...
INSERT INTO `paginas` (`id`, `caminho`, `nome`) VALUES
(1, '\\ci\\application\\views\\staff\\staff_alunos_view', 'Alunos'),
(2, '\\ci\\application\\views\\staff\\staff_alunos_view', 'Vendas'),
(3, '\\ci\\application\\views\\staff\\staff_staff_view', 'Staff'),
(4, '\\ci\\application\\views\\staff\\staff_alunos_view', 'Videos'),
(5, '\\ci\\application\\views\\staff\\staff_cidades_view', 'Cidades');

-- --------------------------------------------------------

--
-- Estrutura da tabela `permissoes_staff_paginas`
--

CREATE TABLE `permissoes_staff_paginas` (
  `id` int(11) NOT NULL,
  `status` varchar(1) DEFAULT NULL,
  `FK_Staff_id` int(11) DEFAULT NULL,
  `FK_Paginas_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `permissoes_staff_paginas`
--

INSERT INTO `permissoes_staff_paginas` (`id`, `status`, `FK_Staff_id`, `FK_Paginas_id`) VALUES
(68, '1', 1, 1),
(69, '1', 1, 2),
(70, '1', 1, 4),
(71, '1', 1, 5),
...
CREATE TABLE `sede` (
  `id` int(11) NOT NULL,
  `nome` varchar(200) DEFAULT NULL,
  `deletada` varchar(1) DEFAULT NULL,
  `FK_Cidade_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sede` (`id`, `nome`, `deletada`, `FK_Cidade_id`) VALUES
(9, 'REPFARMA - Rio de Janeiro', '2', 3658),
(10, 'REPFARMA - Campinas', '2', 4814),
(11, 'REPFARMA - São Paulo', '2', 5270),
(12, 'Ponta Grossa', '2', 3060);
...
INSERT INTO `staff` (`id`, `nome`, `email`, `senha`, `status`, `tipo`) VALUES
(1, 'Gabriel - Desenvolvimento Visageweb', 'utfprdiario@gmail.com', '$2a$05$5b3IlU2Y2gIqNct5CTf3o./bHh75yHDtMASn6LNxFSKo1r9FmIaXW', '1', '1');
...
CREATE TABLE `telefone_usuario` (
  `id` int(11) NOT NULL,
  `FK_Telefone_id` int(11) DEFAULT NULL,
  `FK_Aluno_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `aluno`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Aluno_1` (`FK_Endereco_id`);

--
-- Indexes for table `banco_de_talentos`
--
ALTER TABLE `banco_de_talentos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Banco_de_Talentos_1` (`FK_Aluno_id`);
...
ALTER TABLE `cidade`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Cidade_1` (`FK_Estado_id`);
...
--
-- Indexes for table `cursos_cidade`
--
ALTER TABLE `cursos_cidade`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Cursos_Cidade_Cursos_Cidade_1` (`FK_Cursos_id`),
  ADD KEY `FK_Cursos_Cidade_Cursos_Cidade_2` (`FK_Cidade_id`);
...
ALTER TABLE `endereco`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Endereco_1` (`FK_Cidade_id`);
...
--
-- Indexes for table `gerencia_staff_sede`
--
ALTER TABLE `gerencia_staff_sede`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Gerencia_Staff_Sede_1` (`FK_Staff_id`),
  ADD KEY `FK_Gerencia_Staff_Sede_2` (`FK_Sede_id`);
...
ALTER TABLE `imagem`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Imagem_1` (`FK_Aluno_id`),
  ADD KEY `FK_Imagem_2` (`FK_Staff_id`);
...
ALTER TABLE `matricula`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Matricula_Cursos_Aluno_1` (`FK_Cursos_id`),
  ADD KEY `FK_Matricula_Cursos_Aluno_2` (`FK_Aluno_id`);
...
--
-- Indexes for table `permissoes_staff_paginas`
--
ALTER TABLE `permissoes_staff_paginas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Permissoes_Staff_Paginas_1` (`FK_Staff_id`),
  ADD KEY `FK_Permissoes_Staff_Paginas_2` (`FK_Paginas_id`);
...
ALTER TABLE `sede`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Sede_1` (`FK_Cidade_id`);
...
ALTER TABLE `telefone_usuario`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Telefone_Usuario_Telefone_Aluno_1` (`FK_Telefone_id`),
  ADD KEY `FK_Telefone_Usuario_Telefone_Aluno_2` (`FK_Aluno_id`);
...
ALTER TABLE `video`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_Video_1` (`FK_Aluno_id`),
  ADD KEY `FK_Video_2` (`FK_Staff_id`);
...
--
-- AUTO_INCREMENT for table `banco_de_talentos`
--
ALTER TABLE `banco_de_talentos`
...
--
-- AUTO_INCREMENT for table `cursos_cidade`
--
ALTER TABLE `cursos_cidade`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `gerencia_staff_sede`
--
ALTER TABLE `gerencia_staff_sede`
...
--
-- AUTO_INCREMENT for table `permissoes_staff_paginas`
--
ALTER TABLE `permissoes_staff_paginas`
...
--
ALTER TABLE `aluno`
  ADD CONSTRAINT `FK_Aluno_1` FOREIGN KEY (`FK_Endereco_id`) REFERENCES `endereco` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `banco_de_talentos`
--
ALTER TABLE `banco_de_talentos`
  ADD CONSTRAINT `FK_Banco_de_Talentos_1` FOREIGN KEY (`FK_Aluno_id`) REFERENCES `aluno` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `cidade`
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `FK_Cidade_1` FOREIGN KEY (`FK_Estado_id`) REFERENCES `estado` (`id`);

--
-- Limitadores para a tabela `cursos_cidade`
--
ALTER TABLE `cursos_cidade`
  ADD CONSTRAINT `FK_Cursos_Cidade_Cursos_Cidade_1` FOREIGN KEY (`FK_Cursos_id`) REFERENCES `cursos` (`id`),
  ADD CONSTRAINT `FK_Cursos_Cidade_Cursos_Cidade_2` FOREIGN KEY (`FK_Cidade_id`) REFERENCES `cidade` (`id`);

--
-- Limitadores para a tabela `endereco`
--
ALTER TABLE `endereco`
  ADD CONSTRAINT `FK_Endereco_1` FOREIGN KEY (`FK_Cidade_id`) REFERENCES `cidade` (`id`);

--
-- Limitadores para a tabela `gerencia_staff_sede`
--
ALTER TABLE `gerencia_staff_sede`
  ADD CONSTRAINT `FK_Gerencia_Staff_Sede_1` FOREIGN KEY (`FK_Staff_id`) REFERENCES `staff` (`id`),
  ADD CONSTRAINT `FK_Gerencia_Staff_Sede_2` FOREIGN KEY (`FK_Sede_id`) REFERENCES `sede` (`id`);

--
-- Limitadores para a tabela `imagem`
--
ALTER TABLE `imagem`
  ADD CONSTRAINT `FK_Imagem_1` FOREIGN KEY (`FK_Aluno_id`) REFERENCES `aluno` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Imagem_2` FOREIGN KEY (`FK_Staff_id`) REFERENCES `staff` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `matricula`
--
ALTER TABLE `matricula`
  ADD CONSTRAINT `FK_Matricula_Cursos_Aluno_1` FOREIGN KEY (`FK_Cursos_id`) REFERENCES `cursos` (`id`),
  ADD CONSTRAINT `FK_Matricula_Cursos_Aluno_2` FOREIGN KEY (`FK_Aluno_id`) REFERENCES `aluno` (`id`);

--
-- Limitadores para a tabela `permissoes_staff_paginas`
--
ALTER TABLE `permissoes_staff_paginas`
  ADD CONSTRAINT `FK_Permissoes_Staff_Paginas_1` FOREIGN KEY (`FK_Staff_id`) REFERENCES `staff` (`id`),
  ADD CONSTRAINT `FK_Permissoes_Staff_Paginas_2` FOREIGN KEY (`FK_Paginas_id`) REFERENCES `paginas` (`id`);

--
-- Limitadores para a tabela `sede`
--
ALTER TABLE `sede`
  ADD CONSTRAINT `FK_Sede_1` FOREIGN KEY (`FK_Cidade_id`) REFERENCES `cidade` (`id`);

--
-- Limitadores para a tabela `telefone_usuario`
--
ALTER TABLE `telefone_usuario`
  ADD CONSTRAINT `FK_Telefone_Usuario_Telefone_Aluno_1` FOREIGN KEY (`FK_Telefone_id`) REFERENCES `telefone` (`id`),
  ADD CONSTRAINT `FK_Telefone_Usuario_Telefone_Aluno_2` FOREIGN KEY (`FK_Aluno_id`) REFERENCES `aluno` (`id`);

--
-- Limitadores para a tabela `video`
--
ALTER TABLE `video`
  ADD CONSTRAINT `FK_Video_1` FOREIGN KEY (`FK_Aluno_id`) REFERENCES `aluno` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Video_2` FOREIGN KEY (`FK_Staff_id`) REFERENCES `staff` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
